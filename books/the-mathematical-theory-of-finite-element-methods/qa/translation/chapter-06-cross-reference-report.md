# chapter-06 cross-reference report

- Files checked: 9
- Chapter/batch labels: 79 (79 unique)
- Project-wide unique labels: 789
- LaTeX reference commands: 92
- Explicit unresolved source references: 0
- Duplicate labels: 0
- Undefined local labels: 0
- Incorrect equation/non-equation reference commands: 0
- Registry: `qa/translation/chapter-06-cross-reference-registry.tsv`

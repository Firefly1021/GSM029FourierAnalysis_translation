...
5. Current phase: full-book translation. `chapter-00` through `chapter-13` are complete and passed; the next natural unit is `chapter-14`.
...
8. The user resumed the task after the Chapter 5 checkpoint; Chapter 13 is now passed, so continue from Chapter 14 without revisiting passed units.

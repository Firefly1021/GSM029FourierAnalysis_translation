...
5. Current phase: full-book translation. `chapter-00` through `chapter-12` are complete and passed; the next natural unit is `chapter-13`.
...
8. The user resumed the task after the Chapter 5 checkpoint; Chapter 12 is now passed, so continue from Chapter 13 without revisiting passed units.

...
5. Current phase: full-book translation. `chapter-00` through `chapter-08` are complete and passed; the next natural unit is `chapter-09`.
...
8. The user resumed the task after the Chapter 5 checkpoint; continue from Chapter 9 without revisiting passed units.

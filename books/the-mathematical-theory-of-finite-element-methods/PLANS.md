...
5. Current phase: full-book translation. `chapter-00` through `chapter-06` are complete and passed; the next natural unit is `chapter-07`.
...
8. The user resumed the task after the Chapter 5 checkpoint; continue from Chapter 7 without revisiting passed units.

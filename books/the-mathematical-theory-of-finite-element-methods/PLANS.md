...
5. Current phase: full-book translation. `chapter-00` through `chapter-07` are complete and passed; the next natural unit is `chapter-08`.
...
8. The user resumed the task after the Chapter 5 checkpoint; continue from Chapter 8 without revisiting passed units.

...
5. Current phase: full-book translation. `chapter-00` through `chapter-14` and `frontmatter` are complete and passed; the next natural unit is `references`.
6. The approved Section 6.3 sample was reused without retranslation when Chapter 6 was processed.
...
8. The user resumed the task after the Chapter 5 checkpoint; all numbered chapters and frontmatter are now passed, so continue with references and index without revisiting passed units.

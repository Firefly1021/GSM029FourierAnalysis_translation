...
5. Current phase: full-book translation. `chapter-00` through `chapter-10` are complete and passed; the next natural unit is `chapter-11`.
...
8. The user resumed the task after the Chapter 5 checkpoint; continue from Chapter 10 without revisiting passed units.

...
\hypertarget{chapter-03-page-204}{}
\MBSourceStatementNumber{remark}{1}
\begin{Remark}
\label{rem:ch3-compactness-banach-x0-x-banach}
仅假设 $X_1$ 是 Hilbert 空间, 而 $X_0,X$ 是 Banach 空间时, 可以用类似方法证明, 对任意有限数 $\alpha_0>1$, $Y(0,T;\alpha_0,1;X_0,X_1)$ 到 $L^{\alpha_0}(0,T;X)$ 的注入是紧的.
\end{Remark}

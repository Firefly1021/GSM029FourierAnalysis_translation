...
随后, 在\MBUnresolvedReference{sec:chap6-nonhomogeneous-navier-stokes}{Section 2}中, 我们为这里考虑的耦合系统引入一个完整的近似问题. 这个问题本身的求解并非显然, 它既使用 Schauder 不动点 Theorem, 也使用将在本节证明的输运方程解的稳定性结果.

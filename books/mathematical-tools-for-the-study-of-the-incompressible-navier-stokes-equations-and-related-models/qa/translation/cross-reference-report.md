...
| Formula (I.3) | Earlier equivalent velocity relation | `eq:chap1-velocity-lagrangian` | Outside sample | Known target, deferred; no number fabricated |
...
- Verified PDF destinations: `equation.1.1` and `statement.1.1`.
- Result: Passed.

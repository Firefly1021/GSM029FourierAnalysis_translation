# chapter-04-section-04-part-01 cross-reference report

- Files checked: 1
- Chapter/batch labels: 18 (18 unique)
- Project-wide unique labels: 1478
- LaTeX reference commands: 49
- Explicit unresolved source references: 0
- Duplicate labels: 0
- Undefined local labels: 0
- Incorrect equation/non-equation reference commands: 0
- Registry: `qa/translation/chapter-04-section-04-part-01-cross-reference-registry.tsv`

# chapter-04-section-03-part-01 cross-reference report

- Files checked: 1
- Chapter/batch labels: 15 (15 unique)
- Project-wide unique labels: 1370
- LaTeX reference commands: 27
- Explicit unresolved source references: 0
- Duplicate labels: 0
- Undefined local labels: 0
- Incorrect equation/non-equation reference commands: 0
- Registry: `qa/translation/chapter-04-section-03-part-01-cross-reference-registry.tsv`

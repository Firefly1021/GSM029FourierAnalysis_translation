# frontmatter cross-reference report

- Files checked: 1
- Chapter/batch labels: 1 (1 unique)
- Project-wide unique labels: 1304
- LaTeX reference commands: 5
- Explicit unresolved source references: 0
- Duplicate labels: 0
- Undefined local labels: 0
- Incorrect equation/non-equation reference commands: 0
- Registry: `qa/translation/frontmatter-cross-reference-registry.tsv`
